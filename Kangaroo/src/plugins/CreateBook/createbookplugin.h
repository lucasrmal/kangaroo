...
#ifndef CREATEBOOKPLUGIN_H
#define CREATEBOOKPLUGIN_H
...
class CreateBookPlugin : public QObject, public KLib::IPlugin
{
    Q_OBJECT
    ...
    private:
        QAction* mnuCreateNew;

};

#endif // CREATEBOOKPLUGIN_H
