...
class AccountPaneTree : public QTreeView
{
    ...
    public:
        AccountPaneTree(KLib::SimpleAccountController* _model, QWidget *parent = nullptr);
    ...
    protected:
        void drawBranches(QPainter* _painter, const QRect& _rect, const QModelIndex& _index) const;
        void drawRow(QPainter* _painter, const QStyleOptionViewItem& _option, const QModelIndex& _index) const override;
