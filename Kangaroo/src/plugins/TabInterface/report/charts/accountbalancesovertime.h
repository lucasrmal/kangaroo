#ifndef ACCOUNTBALANCESOVERTIME_H
#define ACCOUNTBALANCESOVERTIME_H
...
class AccountBalancesOverTime : public IChart
{
    Q_OBJECT
    ...
    public:
        AccountBalancesOverTime(QWidget* _parent = nullptr);
...
#endif // ACCOUNTBALANCESOVERTIME_H
