    ...
    switch (s.type) {
      ...
      case SettingType::Account: {
        AccountSelector* sel = new AccountSelector(
            {.selectorFlags =
                 s.allowPlaceholders
                     ? KLib::AccountSelectorFlags::Flag_PlaceholdersClosed
                     : KLib::AccountSelectorFlags::Flag_IncludeClosed,
             .typeFlags = s.flagsToAccountFlags()},
            this);
    ...
    switch (s.type) {
      ...
      case SettingType::Account: {
        ...
        if (!sel->currentAccount()) {
          QMessageBox::information(this, s.description,
