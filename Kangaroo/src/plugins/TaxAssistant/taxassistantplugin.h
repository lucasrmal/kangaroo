...
#ifndef TAXASSISTANTPLUGIN_H
#define TAXASSISTANTPLUGIN_H
...
class TaxAssistantPlugin : public QObject, public KLib::IPlugin
{
    Q_OBJECT
    ...
    private slots:
        //void viewTaxAssistant();

    private:
//        QAction* m_mnuTaxAssistant;
//        TaxAssistant* m_tab;

};

#endif // TAXASSISTANTPLUGIN_H
