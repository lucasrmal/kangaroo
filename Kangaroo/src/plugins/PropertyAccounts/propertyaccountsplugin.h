...
#ifndef PROPERTYACCOUNTSPLUGIN_H
#define PROPERTYACCOUNTSPLUGIN_H

#include <KangarooLib/iplugin.h>
#include <QObject>

class PropertyAccountsPlugin : public QObject, public KLib::IPlugin
{
    Q_OBJECT
    ...
    private:
        bool addRealEstateType(QString& _error);
        bool addMortgageType(QString& _error);

};

#endif // PROPERTYACCOUNTSPLUGIN_H
