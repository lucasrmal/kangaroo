...
#ifndef INVESTMENTBATCHENTRYPLUGIN_H
#define INVESTMENTBATCHENTRYPLUGIN_H

#include <KangarooLib/iplugin.h>
#include <QObject>

class InvestmentBatchEntryPlugin : public QObject, public KLib::IPlugin
{
    Q_OBJECT
...
#endif // INVESTMENTBATCHENTRYPLUGIN_H
