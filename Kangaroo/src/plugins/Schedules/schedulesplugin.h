...
#ifndef SCHEDULESPLUGIN_H
#define SCHEDULESPLUGIN_H
...
class SchedulesPlugin : public QObject, public KLib::IPlugin
{
    Q_OBJECT
    ...
    private slots:
        void viewScheduleEditor();

    private:
        QAction* m_mnuScheduleEditor;
        ScheduleEditor* m_tab;

};

#endif // SCHEDULESPLUGIN_H
