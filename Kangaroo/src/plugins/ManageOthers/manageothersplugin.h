...
#ifndef MANAGEOTHERSPLUGIN_H
#define MANAGEOTHERSPLUGIN_H
...
class ManageOthersPlugin : public QObject, public KLib::IPlugin
{
    Q_OBJECT
    ...
    private:
        QAction* mnuCurrencies;
        QAction* mnuInstitutions;
        QAction* mnuPayees;
        QAction* mnuSecurities;
        QAction* mnuIndexes;
        QAction* mnuPrices;

        QHash<ManageType, QAction*> m_actions;
        QHash<ManageType, ManagerWidget*> m_widgets;


};

#endif // MANAGEOTHERSPLUGIN_H
