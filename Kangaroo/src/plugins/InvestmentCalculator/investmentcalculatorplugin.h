...
#ifndef INVESTMENTCALCULATORPLUGIN_H
#define INVESTMENTCALCULATORPLUGIN_H
...
class InvestmentCalculatorPlugin : public QObject, public KLib::IPlugin
{
    Q_OBJECT
    ...
    private:
        QAction* mnuCalc;
        FormCalculator* m_calc;

};

#endif // INVESTMENTCALCULATORPLUGIN_H
