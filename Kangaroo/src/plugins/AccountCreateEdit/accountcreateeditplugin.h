...
#ifndef ACCOUNTCREATEEDITPLUGIN_H
#define ACCOUNTCREATEEDITPLUGIN_H

#include <KangarooLib/iplugin.h>
#include <QObject>

class AccountCreateEditPlugin : public QObject, public KLib::IPlugin
{
    Q_OBJECT
...
#endif // ACCOUNTCREATEEDITPLUGIN_H
