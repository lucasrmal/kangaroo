...
QT += widgets script
TARGET = FrequentAccounts
TEMPLATE = lib
CONFIG       += plugin
DESTDIR = ../../../plugins
INCLUDEPATH += ../../../../
SOURCES += frequentaccountsplugin.cpp \
    frequentaccounts.cpp \
    formeditfrequentaccounts.cpp
HEADERS += frequentaccountsplugin.h \
    frequentaccounts.h \
    formeditfrequentaccounts.h
