...
#ifndef ACCOUNTTREEWIDGETPLUGIN_H
#define ACCOUNTTREEWIDGETPLUGIN_H

#include <KangarooLib/iplugin.h>
#include <QObject>

class AccountTreeWidgetPlugin : public QObject, public KLib::IPlugin
{
    Q_OBJECT
...
#endif // ACCOUNTTREEWIDGETPLUGIN_H
