...
#ifndef KMYMONEYIMPORTPLUGIN_H
#define KMYMONEYIMPORTPLUGIN_H

#include <KangarooLib/iplugin.h>
#include <QObject>

class KMyMoneyImportPlugin : public QObject, public KLib::IPlugin
{
    Q_OBJECT
