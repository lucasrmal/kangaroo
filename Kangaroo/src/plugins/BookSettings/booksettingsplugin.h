...
#ifndef BOOKSETTINGSPLUGIN_H
#define BOOKSETTINGSPLUGIN_H
...
class BookSettingsPlugin : public QObject, public KLib::IPlugin
{
    Q_OBJECT
    ...
    public slots:
        void editBookSettings();

    private:
        QAction* mnuBookSettings;

};

#endif // BOOKSETTINGSPLUGIN_H
