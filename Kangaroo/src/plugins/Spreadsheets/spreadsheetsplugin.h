...
#ifndef SPREADSHEETSPLUGIN_H
#define SPREADSHEETSPLUGIN_H
...
class SpreadsheetsPlugin : public QObject, public KLib::IPlugin
{
    Q_OBJECT
    ...
    private slots:
        void viewSpreadsheet();

    private:
        QAction* m_mnuSpreadsheet;
        SpreadsheetViewer* m_spreadsheet;

};

#endif // SPREADSHEETSPLUGIN_H
