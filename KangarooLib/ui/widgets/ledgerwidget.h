...
//    class ControlOverlay;
    ...
    struct LedgerAction
    {
        ...
        LedgerAction(QAction* _action, bool _isPrimary, sel_func _selChanged, trig_func _trig);
        ...
        /**
         * @brief Called when selection is changed, will activate or desactivate the action depending on the return value.
         *
    ...
    class LedgerWidget : public QTreeView
    {
        ...
        public:
            ...
            /**
             * @return Returns if a transaction is currently being edited (including new transactions).
             */
            bool inEdit() const;
            ...
            /**
             * @brief Returns the (main) rows that are currently selected in the ledger. This is NOT guaranteed to be sorted.
             * @return
             */
            QList<int> selectedRows() const;

            /**
             * @brief Returns the (main) row in the ledger that corresponds to the new (blank) transaction.
             * @return
             */
            ...
            LedgerAction* basicAction(BasicLedgerAction _action) const { return m_basicActions.value(_action, nullptr); }
        ...
        public slots:
             ...
             *
             * Only works if a single row is selected and that row is a scheduled transaction.
             */
            void enterSchedule();
        ...
        protected:
            ...
            bool edit(const QModelIndex& _index, EditTrigger _trigger, QEvent* _event) override;
        ...
        protected slots:
            ...
            void closeEditor(QWidget* _editor, QAbstractItemDelegate::EndEditHint _hint) override;
