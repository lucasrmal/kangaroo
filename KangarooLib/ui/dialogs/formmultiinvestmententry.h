...
class MultiInvestmentModel : public QAbstractTableModel
{
  ...
  public:
    ...
    MultiInvestmentModel(const QLinkedList<Account*>& _accounts, QObject* _parent);
...
class MultiInvestmentEntryDelegate : public QStyledItemDelegate
{
    ...
    public:
        MultiInvestmentEntryDelegate(const MultiInvestmentModel* _model, QObject* _parent);
