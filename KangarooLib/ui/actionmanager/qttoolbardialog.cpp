...
//    ui.currentToolBarList->setAcceptDrops(true);
    ...
    d_ptr->ui.upButton->setIcon(KLib::Core::icon("go-up"));
    d_ptr->ui.downButton->setIcon(KLib::Core::icon("go-down"));
    d_ptr->ui.leftButton->setIcon(KLib::Core::icon("go-previous"));
    d_ptr->ui.rightButton->setIcon(KLib::Core::icon("go-next"));
    d_ptr->ui.newButton->setIcon(KLib::Core::icon("list-add"));
    d_ptr->ui.removeButton->setIcon(KLib::Core::icon("list-remove"));
    d_ptr->ui.okButton->setIcon(KLib::Core::icon("ok"));
    d_ptr->ui.applyButton->setIcon(KLib::Core::icon("apply"));
    d_ptr->ui.cancelButton->setIcon(KLib::Core::icon("close"));
    d_ptr->ui.defaultButton->setIcon(KLib::Core::icon("undo"));
