...
CurrencyController::CurrencyController(QObject *parent)
    : QAbstractTableModel(parent),
      m_manager(CurrencyManager::instance())
{
    connect(m_manager, SIGNAL(currencyAdded(KLib::Currency*)), this, SLOT(onCurrencyAdded(KLib::Currency*)));
    connect(m_manager, SIGNAL(currencyModified(KLib::Currency*)), this, SLOT(onCurrencyModified(KLib::Currency*)));
    connect(m_manager, SIGNAL(currencyRemoved(KLib::Currency*)), this, SLOT(onCurrencyRemoved(KLib::Currency*)));
}
...
QVariant CurrencyController::headerData(int section, Qt::Orientation orientation, int role) const
{
...
bool CurrencyController::setData(const QModelIndex &index, const QVariant &value, int role)
{
    Q_UNUSED(index)
    Q_UNUSED(value)
    Q_UNUSED(role)
